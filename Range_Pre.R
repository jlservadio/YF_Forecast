...
train$Tmp.L = make.lag(train, 'range_Tmp', 'GID_2', 'Week', lag.per)
train$Tmp.L2 = make.lag(train, 'range_Tmp2', 'GID_2', 'Week', lag.per)
train$Rain.L = make.lag(train, 'range_Rain', 'GID_2', 'Week', lag.per)
train$Rain.L2 = make.lag(train, 'range_Rain2', 'GID_2', 'Week', lag.per)
train$Hum.L = make.lag(train, 'range_Hum', 'GID_2', 'Week', lag.per)
train$Hum.L2 = make.lag(train, 'range_Hum2', 'GID_2', 'Week', lag.per)
train$Cases.bin.L = make.lag(train, 'Cases.bin', 'GID_2', 'Week', lag.per)
train$Incidence.L = make.lag(train, 'Inc', 'GID_2', 'Week', lag.per)


test$Tmp.L = make.lag(test, 'range_Tmp', 'GID_2', 'Week', lag.per)
test$Tmp.L2 = make.lag(test, 'range_Tmp2', 'GID_2', 'Week', lag.per)
test$Rain.L = make.lag(test, 'range_Rain', 'GID_2', 'Week', lag.per)
test$Rain.L2 = make.lag(test, 'range_Rain2', 'GID_2', 'Week', lag.per)
test$Hum.L = make.lag(test, 'range_Hum', 'GID_2', 'Week', lag.per)
test$Hum.L2 = make.lag(test, 'range_Hum2', 'GID_2', 'Week', lag.per)
...
covars = covars[which(covars[ , ncol(covars)] > 0), ]
...
range.pre.res = list(all.res.lag2, all.res.lag3, all.res.lag4, all.res.lag5, 
	all.res.lag6, all.res.lag7, all.res.lag8)
save(range.pre.res, file = 'range_pre_res.Rdata')
